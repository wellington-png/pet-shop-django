...
urlpatterns = [
    ...
    path("tecnico/update/<int:pk>/", TecnicoUpdateView.as_view(), name="tecnico_update"),
    path("tecnico/delete/<int:pk>/", TecnicoDeleteView.as_view(), name="tecnico_delete"),
    ...
    path("veterinario/update/<int:pk>/", VeterinarioUpdateView.as_view(), name="veterinario_update"),
    path("veterinario/delete/<int:pk>/", VeterinarioDeleteView.as_view(), name="veterinario_delete"),
    ...
    path("atendente/update/<int:pk>/", AtendenteUpdateView.as_view(), name="atendente_update"),
    path("atendente/delete/<int:pk>/", AtendenteDeleteView.as_view(), name="atendente_delete"),
]