...
urlpatterns = [
    ...
    path(
        "servico/update/<int:pk>/", ServicoUpdateView.as_view(), name="servico_update"
    ),
    path(
        "servico/delete/<int:pk>/", ServicoDeleteView.as_view(), name="servico_delete"
    ),
    path(
        "tipo_servico/create/",
        TipoServicoCreateView.as_view(),
        name="tipo_servico_create",
    ),
    path("tipo_servico/list/", TipoServicoListView.as_view(), name="tipo_servico_list"),
    path(
        "tipo_servico/update/<int:pk>/",
        TipoServicoUpdateView.as_view(),
        name="tipo_servico_update",
    ),
    path(
        "tipo_servico/delete/<int:pk>/",
        TipoServicoDeleteView.as_view(),
        name="tipo_servico_delete",
    ),
